...
extern void mpu6500_read_temp(fp32 *temperature);
extern void mpu6500_read_accel(fp32 accel[3]);
extern void mpu6500_read_gyro(fp32 gyro[3]);
extern void mpu6500_read(fp32 gyro[3],fp32 accel[3],fp32 *temperature);
#endif
